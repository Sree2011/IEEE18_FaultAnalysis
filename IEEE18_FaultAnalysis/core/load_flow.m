## --*texinfo*--
## @deftypescript {Function File} {load_flow}
## @brief Newton-Raphson load flow solver
##
## @param bus_data Matrix containing bus information
## @param Y Admittance matrix (Ybus)
## @param gen_data Matrix containing generator information
## @return V Voltage magnitudes at buses
## @return theta Voltage angles at buses
## @return P Active power injections at buses
## @return Q Reactive power injections at buses
## @end deftypescript
function [V, theta, P, Q] = load_flow(bus_data, Y, gen_data)
